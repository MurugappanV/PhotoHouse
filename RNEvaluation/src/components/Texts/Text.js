...
export function LargeText(props: Props) {
	return (
		<Text {...props.textProps} style={StyleSheet.flatten([styles.largeText, props.style])}>
			{props.text}
		</Text>
	);
}
...
export function MediumText(props: Props) {
	return (
		<Text {...props.textProps} style={StyleSheet.flatten([styles.mediumText, props.style])}>
			{props.text}
		</Text>
	);
}
...
export function SmallText(props: Props) {
	return (
		<Text {...props.textProps} style={StyleSheet.flatten([styles.smallText, props.style])}>
			{props.text}
		</Text>
	);
}
